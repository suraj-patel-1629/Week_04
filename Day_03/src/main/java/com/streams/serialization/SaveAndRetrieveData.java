...
public class SaveAndRetrieveData {
    public static void main(String[] args) {
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("src/main/java/com/streams/serialization/writeObject.txt",true))) {
            oos.writeObject(e1);
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("src/main/java/com/streams/serialization/writeObject.txt"))) {
