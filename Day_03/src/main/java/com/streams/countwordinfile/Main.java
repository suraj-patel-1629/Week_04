...
public class Main {
    public static void main(String[] args) {
        File filePath = new File("src/main/java/com/streams/countwordinfile/TestingFile.txt");
        ...
        for (int i = 0; i < Math.min(5, wordList.size()); i++) { // Ensure we don’t exceed the list size
